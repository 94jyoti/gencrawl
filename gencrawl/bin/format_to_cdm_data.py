...
if __name__ == "__main__":
    ...
    column_list = ['Ex Date','Pay Date','Record Date','CG Record Date','CG Ex Date','CG Pay Date','Long Term (Per Share)','Short Term (Per Share)','Per Share','Total (Per Share)']
    ...
    outputdf1.to_csv('federated.csv', index=False, )