        ...
        for i in items:
            ...
            for fund in temp_fund_manager_list:
                ...
                dict= {"fund_manager": "", "fund_manager_years_of_experience_in_industry": "", "fund_manager_firm": "",
                       ...
                       'fund_managers': str(temp_fund_manager_list[fund]).split(",")[0],
                       'fund_manager_years_of_experience_with_fund': str(temp_fund_manager_list[fund]).split(" ")[-1]}
