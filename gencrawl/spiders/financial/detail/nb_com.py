...
class NbComDetail(FinancialDetailSpider):
    ...
    def get_items_or_req(self, response, default_item={}):
        ...
        #print(url)
        yield scrapy.Request(url, callback=self.dividends,meta=meta,dont_filter=True,headers=headers,cookies={"lang":"en","www.nb.com":"audience=2563a9a5-4a40-4559-8b67-866d83ef2285"})
