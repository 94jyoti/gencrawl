...
class FeimComDetail(FinancialDetailFieldMapSpider):
    ...
    def get_items_or_req(self, response, default_item=None):
        ...
        try:
            ...
            print(list(json_data['charts']))
            print(list(json_data['charts'])[-1])
            ...
            for item in range(len(items)):
                ...
                dist_node_value = list(json_data['charts'])[-2]
                distribution_data1 = json_data['charts'][dist_node_value]
                # print(distribution_data1)
                print("datatatataatatatatatatatat", json_data['charts'][dist_node_value]['data_info']['chart_title'])
                if ("Dividend" in json_data['charts'][dist_node_value]['data_info']['chart_title']):
                    #if ("Dividend" in json_data['charts'][dist_node_value]['data_info']['chart_title']):
                    dist_data1 = distribution_data1['data_info']['data'][dict_key]
                    #else:
                     #   dist_data1 = distribution_data['data_info']['data'][dict_key]
                    print(dist_data1)
                    for data in dist_data1.values():
